...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--projector",
        help="Projector to use (Siddon (S), Distance-driven (DD), CUDA Joseph (J), or CUDA Joseph LPP (JL))",
    )
    parser.add_argument(
        "--num_rays",
    ...
    elif args.projector == "JL":
        op_proj = yrt.OperatorProjectorJosephLPP_GPU(proj_params)
    else:
