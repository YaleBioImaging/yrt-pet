...
constexpr float SQRT2_FLT = 1.41421356237f;
constexpr double SPEED_OF_LIGHT_MM_PS = 0.299792458;
constexpr float SPEED_OF_LIGHT_MM_PS_FLT = 0.299792458f;
...
constexpr double EPS = 2.2204460e-16;
constexpr float EPS_FLT = 1.19209e-07f;
constexpr double SIGMA_TO_FWHM = 2.354820045031;
constexpr float SIGMA_TO_FWHM_FLT = 2.3548200f;
constexpr double SMALL = 1.0e-8;
constexpr float SMALL_FLT = 1.0e-8f;
