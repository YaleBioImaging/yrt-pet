...
__device__ inline const float*
    getKernel(const float* pd_kernels,
              const ProjectionPsfProperties& projectionPsfProperties, float p1x,
...
__device__ inline float
    getWeight(const float* pd_kernel,
              const ProjectionPsfProperties& projectionPsfProperties, float x0,
              float x1)
{
	...
	return util::calculateIntegral(pd_kernel,
	                               projectionPsfProperties.kernelSize,
