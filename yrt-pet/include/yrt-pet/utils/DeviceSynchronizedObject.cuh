...
template <typename T>
class DeviceSynchronizedObject
{
public:
	template <typename... Args>
	DeviceSynchronizedObject(Args&&... args) : m_hostSideObject(std::forward<Args>(args)...)
	{
		// Allocate on device
	...
	~DeviceSynchronizedObject() { cudaFree(mpd_deviceSideObject); }
